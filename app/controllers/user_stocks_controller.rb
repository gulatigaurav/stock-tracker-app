class UserStocksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to myportfolio_path, notice: "Stock #{@user_stock.stock.ticker} was successfully added" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to myportfolio_path, notice: 'Stock was successfully removed from your list' }
  ...
  private
    ...
    def set_user_stock
         @user_stock = UserStock.where(stock_id: params[:id]  , user_id: current_user.id)
       end
